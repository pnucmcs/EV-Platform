...
public interface IReservationRepository
{
    ...
    Task AddAsync(Reservation reservation, IEnumerable<object>? outboxMessages = null, CancellationToken cancellationToken = default);
    Task UpdateAsync(Reservation reservation, IEnumerable<object>? outboxMessages = null, CancellationToken cancellationToken = default);
    ...
    Task AddSessionAsync(ChargingSession session, IEnumerable<object>? outboxMessages = null, CancellationToken cancellationToken = default);
    Task UpdateSessionAsync(ChargingSession session, IEnumerable<object>? outboxMessages = null, CancellationToken cancellationToken = default);
